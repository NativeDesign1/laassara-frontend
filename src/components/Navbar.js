...
const Navbar = () => {
  ...
  return (
    <nav>
      <div className="relative bg-gradient-to-r from-green-400 to-blue-400 py-3 px-6 flex flex-col md:items-center md:flex-row md:space-x-24 space-x-0 space-y-4  md:space-y-0 md:justify-between items-center text-white shadow-md">
        ...
        <div className="flex items-center md:mr-24 space-x-2">
          <FontAwesomeIcon
            icon={faCreditCard}
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden bg-opacity-95 absolute h-[100%] pb-5 z-50 top-26  w-full bg-white transition-all items-center duration-300 ease-in-out ${
