      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md relative">
          ...
          <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">
            Heb je vragen? Wil je graag feedback sturen? Interesse in een samenwerking? Laat het ons weten.
          </p>
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="sm:col-span-2">
              <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Jouw vraag</label>
              <textarea
                id="message"
                rows="6"
